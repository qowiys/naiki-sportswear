"""
Django settings for naiki_sportswear project.
...
SECRET_KEY = 'django-insecure-*oiy*_8_#y%kukr@z-#xb@k-_v*enxwiz)n%jj&unqu1f70$l='
...
WSGI_APPLICATION = 'naiki_sportswear.wsgi.application'
